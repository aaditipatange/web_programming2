					...
					<CardActionArea>
						<Link to={`/series/${series.id}`}>
							<CardMedia
								...
								component='img'
								image={series.thumbnail ? `${series.thumbnail.path}/portrait_fantastic.${series.thumbnail.extension}` : noImage}
								title='Char image'
							/>
							...
							<CardContent>
								...
								<Typography variant='body2' color='textSecondary' component='p'>
									{series.description ? series.description.replace(regex, '').substring(0, 139) + '...' : 'No Description'}
								</Typography>
							</CardContent>
						</Link>
					</CardActionArea>
